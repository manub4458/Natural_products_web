...
const SecondSection = () => {
  return (
   <>
   <div className='bg-white mx-32 hair_explore border h-fit pt-16 pb-6 -translate-y-8 rounded-md'>

    <div>
        <h2 className='text-center py-4 text-2xl hair_explore_h1 font-semibold armen'>
        Explore a wide range of our haircare products 
        </h2>
    </div>
        <div>

            <p className='text-center mx-20 hair_explore_p armen'>

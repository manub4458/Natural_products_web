...
const SecondSection = () => {
  return (
   <>
   <div className='bg-white mx-32 border h-fit pt-16 pb-6 -translate-y-10 rounded-md'>

    <div>
        <h2 className='text-center py-4 text-2xl armen font-semibold'>
        Explore a wide range of our skincare products 
        </h2>
    </div>
        <div>

            <p className='text-center mx-20 armen'>
